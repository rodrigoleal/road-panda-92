...
export const HOMEPAGE_QUERY = gql`
  query HomepageQuery {
    ...
    encontros3g: posts(first: 3, where: { categoryName: "encontros-3g" }) {
      nodes {
        id
        title
        slug
    ...
    maquinasIntemporais: posts(first: 3, where: { categoryName: "maquinas-intemporais" }) {
      nodes {
        id
        title
        slug
    ...
    viagemAtlantica: posts(first: 3, where: { categoryName: "viagem-atlantica" }) {
      nodes {
        id
        title
        slug
    ...
    historiasIconicas: posts(first: 3, where: { categoryName: "historias-iconicas" }) {
      nodes {
        id
        title
        slug
    ...
    videos: posts(first: 3, where: { categoryName: "videos" }) {
      nodes {
        id
        title
        slug
    ...
    copiloto: posts(first: 3, where: { categoryName: "copiloto" }) {
      nodes {
        id
        title
        slug
