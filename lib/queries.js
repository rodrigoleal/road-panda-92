...
export const HOMEPAGE_QUERY = gql`
  query HomepageQuery {
    ...
    classicos: posts(first: 3, where: { categoryName: "classicos" }) {
      nodes {
        id
        title
        slug
    ...
    ensaios: posts(first: 3, where: { categoryName: "ensaios" }) {
      nodes {
        id
        title
        slug
    ...
    noticias: posts(first: 3, where: { categoryName: "noticias" }) {
      nodes {
        id
        title
        slug
    ...
    opiniao: posts(first: 3, where: { categoryName: "opiniao" }) {
      nodes {
        id
        title
        slug
