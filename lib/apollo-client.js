...
export function getClient() {
  let API_URL = process.env.NEXT_PUBLIC_WORDPRESS_API_URL || "http://localhost:8000/graphql";

  // Use relative proxy on client-side to bypass Mixed Content issues (HTTPS -> HTTP)
  if (typeof window !== "undefined") {
    API_URL = "/api/wp-proxy";
  }
